...
ZEROTWO_IMG = "https://telegra.ph/file/431970b78f306d066a5b5.jpg"

DONATE_STRING = """Heya, senang mendengar Anda ingin menyumbang!
 Anda dapat mendukung proyek ini dengan menghubungi @Anon907 \
 Mendukung tidak selalu finansial! \
 Mereka yang tidak dapat memberikan dukungan uang dipersilakan untuk membantu kami mengembangkan bot di @heinoob."""
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Support",
                            url="https://t.me/gabutan_virtualll",
                        ),
                        InlineKeyboardButton(
                            text=str("Announcement's"),
                            url="https://t.me/Anon907",
                        InlineKeyboardButton(
                            text=str("Announcement's"),
                            url="https://t.me/banned_33",
                        ),
                    ],
                ],
            ),
...
async def help_button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    HELP_STRINGS = """
    Hey there!.
    My Name is {}, dari Sayang di The KingEx. Bawa saya sebagai kekasih grup Anda untuk bersenang-senang dengan saya. \
    Saya dapat membantu Anda dengan perintah berikut.
...
async def donate(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1928892692 and DONATION_LINK:
            await update.effective_message.reply_text(
